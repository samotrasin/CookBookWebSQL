...
namespace CookBookWebSQL.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "RestaurantMenuRestaurants",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantMenuRestaurants", x => new { x.RestaurantMenusId, x.RestaurantsId });
                    table.ForeignKey(
                        name: "FK_RestaurantMenuRestaurants_RestaurantMenus_RestaurantMenusId",
                        column: x => x.RestaurantMenusId,
                        principalTable: "RestaurantMenus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestaurantMenuRestaurants_Restaurants_RestaurantsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantMenuRestaurants_RestaurantsId",
                table: "RestaurantMenuRestaurants",
