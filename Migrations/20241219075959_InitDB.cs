...
namespace CookBookWebSQL.Migrations
{
    ...
    public partial class InitDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "RestaurantMenuImages",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MenuPath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RestaurantMenuId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantMenuImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RestaurantMenuImages_RestaurantMenus_RestaurantMenuId",
            ...
            migrationBuilder.CreateTable(
                name: "RestaurantRestaurantMenu",
                columns: table => new
                {
                    RestaurantMenusId = table.Column<int>(type: "int", nullable: false),
                    RestaurantsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantRestaurantMenu", x => new { x.RestaurantMenusId, x.RestaurantsId });
                    table.ForeignKey(
                        name: "FK_RestaurantRestaurantMenu_RestaurantMenus_RestaurantMenusId",
                        column: x => x.RestaurantMenusId,
                        principalTable: "RestaurantMenus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestaurantRestaurantMenu_Restaurants_RestaurantsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantMenuImages_RestaurantMenuId",
                table: "RestaurantMenuImages",
                column: "RestaurantMenuId");

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantRestaurantMenu_RestaurantsId",
                table: "RestaurantRestaurantMenu",
